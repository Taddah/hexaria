...
<div class="flex flex-col items-center gap-2">
	<svg viewBox="0 0 200 340" width="150" height="255" xmlns="http://www.w3.org/2000/svg">
		<!-- Jambe gauche -->
		<g
			role="img"
		...
		<g
			...
			onmouseenter={() => (hoveredPart = BodyPart.ARM_LEFT)}
			onmouseleave={() => (hoveredPart = null)}
			class="cursor-pointer"
		>
			<ellipse
		...
		<g
			...
			onmouseenter={() => (hoveredPart = BodyPart.ARM_RIGHT)}
			onmouseleave={() => (hoveredPart = null)}
			class="cursor-pointer"
		>
			<ellipse
	...
	{#if hoveredPart && body}
		<div
			class="flex h-7 w-full items-center justify-center rounded px-2"
